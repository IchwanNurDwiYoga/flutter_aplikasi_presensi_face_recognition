...
class PresensiPulangPage extends StatefulWidget {
  ...
  @override
  State<PresensiPulangPage> createState() => _PresensiPulangPageState();
}
...
class _PresensiPulangPageState extends State<PresensiPulangPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Isi Presensi Pulang'),
  ...
  Future updatePresensi() async {
    final response = await http.put(
        Uri.parse(Api().API_END_POINT +
            "/pegawai/presensi/pulang/${widget.kode_presensi}"),
        body: {
          "nip": nipController.text,
          'lat_pulang': widget.latitude,
          'long_pulang': widget.longitude
        });

    print([lat.text, long.text, jsonDecode(response.body)]);
