...
class _PengajuanIzinPageState extends State<PengajuanIzinPage>
  ...
  Future upadePresensiIzin() async {
    final response = await http.put(
        Uri.parse(Api().API_END_POINT +
            '/pegawai/presensi/izin/${widget.kode_presensi}'),
        body: {'nip': nip.text, 'alasan': alasan.text});
